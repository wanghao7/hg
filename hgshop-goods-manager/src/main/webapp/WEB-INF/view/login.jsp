...
<meta name="theme-color" content="#563d7c">
  ...
  <body class="text-center">
    <form class="form-signin" action="/login" method="post">
	  <img class="mb-4" src="/resource/img/d54a1fa7ly1g9ak1fguvjg20750csx6q.gif"" alt="" width="72" height="72">
	  <h1 class="h3 mb-3 font-weight-normal">请!</h1>
	  <label for="inputEmail" class="sr-only">账号</label>
	  <input type="text"  name="name" id="inputEmail" class="form-control" placeholder="账号" >
