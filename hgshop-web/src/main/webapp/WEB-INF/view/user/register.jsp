...
<meta name="theme-color" content="#563d7c">
  ...
  <body class="text-center">
    <form class="form-signin" action="/user/register" method="post">
	  <h1 class="h3 mb-3 font-weight-normal">注册界面</h1>
	  <label for="inputEmail" class="sr-only">新账号</label>
	  <input type="text"  name="username" id="inputEmail" class="form-control" placeholder="新账号" >
	  <label for="inputPassword" class="sr-only"></label>
	  <input type="password" id="inputPassword" name="password" class="form-control" placeholder="密码" >
	  <label for="inputPassword" class="sr-only"></label>
	  <input type="text" id="inputPassword" name="name" class="form-control" placeholder="姓名" >
	  <label for="inputPassword" class="sr-only"></label>
	  ...
	  <label for="inputPassword" class="sr-only"></label>
	  <input type="text" id="inputPassword" name="birthday" class="form-control" placeholder="生日" >
	  <label for="inputPassword" class="sr-only"></label>
	  <input type="radio"  name="sex" class="form-control" placeholder="性别" value="男" >男
	  <input type="radio"  name="sex" class="form-control" placeholder="性别" value="女" >女
